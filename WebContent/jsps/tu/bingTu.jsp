...
series : [
 {
     ...
     data:[
         {value:renshuData[0], name:xueliData[0],itemStyle:{color:'red'}},
         {value:renshuData[1], name:xueliData[1],itemStyle:{color:'blue'}},
         {value:renshuData[2], name:xueliData[2],itemStyle:{color:'green'}},
         {value:renshuData[3], name:xueliData[3],itemStyle:{color:'pink'}}
     ]
 }
]
